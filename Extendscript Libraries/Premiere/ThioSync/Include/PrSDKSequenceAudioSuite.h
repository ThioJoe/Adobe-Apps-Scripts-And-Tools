...
#define kPrSDKSequenceAudioSuiteVersion3		3	// started for 22.1, MakeAudioRendererWithQuality

#define kPrSDKSequenceAudioSuiteVersion			kPrSDKSequenceAudioSuiteVersion3
...
// Allow users to specify the desired render quality to the Audio Renderer.
typedef struct
{
	//
	prSuiteError (*MakeAudioRenderer)(
	...
	// Functionally the same as MakeAudioRenderer, but allows for the desired render quality
	// to be specified.
	//
	// kPrRenderQuality_Draft: Linear Audio Resampling (high aliasing, high speed)
	// kPrRenderQuality_Low / kPrRenderQuality_Medium: Cubic Resampling (mid aliasing, mid speed)
	// kPrRenderQuality_High / kPrRenderQuality_Max: Sinc Resampling (no measurable aliasing, very slow).
...
typedef PrSDKSequenceAudioSuite3 PrSDKSequenceAudioSuite;
